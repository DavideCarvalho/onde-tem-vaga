...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/dudousxd/documents/personal/onde-tem-vaga/public/storage' => 'string',
            'horizon.domain' => 'NULL',
            'horizon.path' => 'string',
            'horizon.use' => 'string',
            ...
            'web-tinker.path' => 'string',
            'web-tinker.theme' => 'string',
            'web-tinker.enabled' => 'boolean',
            'web-tinker.output_modifier' => 'string',
            'web-tinker.middleware' => 'array',
            'web-tinker.config_file' => 'NULL',
            'view.paths' => 'array',
            ...
            'inspector.key' => 'NULL',
            'inspector.url' => 'string',
            'inspector.transport' => 'string',
            'inspector.max_items' => 'integer',
            'inspector.options' => 'array',
            'inspector.query' => 'boolean',
            'inspector.bindings' => 'boolean',
            'inspector.user' => 'boolean',
            'inspector.email' => 'boolean',
            'inspector.notifications' => 'boolean',
            'inspector.views' => 'boolean',
            'inspector.job' => 'boolean',
            'inspector.job_data' => 'boolean',
            'inspector.redis' => 'boolean',
            'inspector.unhandled_exceptions' => 'boolean',
            'inspector.http_client' => 'boolean',
            'inspector.http_client_body' => 'boolean',
            'inspector.hidden_parameters' => 'array',
            'inspector.ignore_commands' => 'array',
            'inspector.ignore_url' => 'array',
            'inspector.ignore_jobs' => 'array',
...
'viewPulse','viewWebTinker','viewHorizon','viewTelescope',);
...
'cors.allowed_headers','cors.exposed_headers','cors.max_age','cors.supports_credentials','data.date_format',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/dudousxd/documents/personal/onde-tem-vaga/public/storage',
...
'ide-helper.macroable_traits','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist','inertia.testing.page_paths',
...
'logging.channels.emergency.path','magellan.schema','magellan.json_generator','magellan.sql_generator','magellan.string_generator',
'magellan.geodetic_srids','magellan.geodetic_default_srid','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','pulse.domain','pulse.path',
...
'queue.batching.table','queue.failed.driver','queue.failed.database','queue.failed.table','roach.request_queue',
'roach.client','roach.default_spider_namespace','services.postmark.token','services.ses.key','services.ses.secret',
'services.ses.region','services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.ip2location.key',
...
'typescript-transformer.transform_null_to_optional','web-tinker.path','web-tinker.theme','web-tinker.enabled','web-tinker.output_modifier',
'web-tinker.middleware','web-tinker.config_file','view.paths','view.compiled','hashing.driver',
...
'broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','concurrency.default','inspector.enable',
'inspector.key','inspector.url','inspector.transport','inspector.max_items','inspector.options',
'inspector.query','inspector.bindings','inspector.user','inspector.email','inspector.notifications',
'inspector.views','inspector.job','inspector.job_data','inspector.redis','inspector.unhandled_exceptions',
'inspector.http_client','inspector.http_client_body','inspector.hidden_parameters','inspector.ignore_commands','inspector.ignore_url',
'inspector.ignore_jobs','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'livewire.navigate.show_progress_bar','livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','structure-discoverer.ignored_files',
...
'horizon.failed-jobs.show','horizon.retry-jobs.show','horizon.jobs.show','horizon.index','pulse','telescope','livewire.update','livewire.upload-file','livewire.preview-file','home','web.dashboard','api.used-spots',
'api.earnings','api.pricing-options','api.parking.parked-vehicles','api.parking.entry','api.parking.exit',
'api.parking.available-spots','api.parking.calculate-fee','api.parking.nearby',
...
'app','pulse::dashboard','vendor.pulse.dashboard','7224ff0b1fa42156c352216deff15b56::card','7224ff0b1fa42156c352216deff15b56::card-header',
...
'pulse::livewire.usage','telescope::layout','web-tinker::web-tinker',);
